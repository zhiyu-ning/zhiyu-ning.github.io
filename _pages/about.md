...
<div style="display: flex; flex-wrap: wrap; align-items: center; margin-bottom: 30px;">
  ...
  <div style="flex: 1; min-width: 300px; font-size: 16px; line-height: 1.6;">
    <strong>Zhiyu Ning</strong>†, Zeyang Liu†*, Deqian Zheng, Niu Liu, Hao Gao, Tianzhang Peng, Ziqian Xi, Xinliang Zhang, Cheng Zhang*, <ahref="https://doi.org/10.1002/nap2.70078" style="text-decoration: underline; color: #2b7bb9;">"Waveguide-based four-channel crosstalk-free metahologram multiplexed by diffraction orders"</a>, <strong><em>Nanophotonics</em></strong>, e70078 (2026).
  </div>
</div>
